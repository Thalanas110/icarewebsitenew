...
export function useQuery<T>({ queryKey, queryFn, enabled = true, refetchInterval }: UseQueryOptions<T>): UseQueryResult<T> {
...
export function useMutation<TVariables, TData>({ mutationFn, onSuccess }: { mutationFn: (variables: TVariables) => Promise<TData>, onSuccess?: () => void }) {
